...
function Contact() {
  ...
  const contactInfo = [
    { icon:'💬', title:'WhatsApp', details:'+234 800 000 0000', action:'https://wa.me/2348000000000', actionText:'Chat Now' },
    { icon:'📧', title:'Email', details:'info@thedigitalartistpush.com', action:'mailto:info@thedigitalartistpush.com', actionText:'Send Email' },
    { icon:'📍', title:'Location', details:'Lagos, Nigeria\nServing artists worldwide', action:'#', actionText:'Get Directions' },
    { icon:'🕐', title:'Business Hours', details:'Mon-Fri: 9AM-6PM\nSat: 10AM-4PM\nSun: Closed', action:'#', actionText:null },
  ]
  const socialLinks = [
    { icon:'📸', name:'Instagram', url:'#' }, { icon:'🐦', name:'X (Twitter)', url:'#' },
    { icon:'👍', name:'Facebook', url:'#' }, { icon:'▶️', name:'YouTube', url:'#' },
    ...
    <main>
        ...
        <div className="contact-grid">
          <AnimatedSection><div className="contact-form">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="btn btn-whatsapp btn-large" style={{ width:'100%' }}>💬 Send Message via WhatsApp</button>
            </form>
          </div></AnimatedSection>
      ...
      <section className="cta-section">
        <motion.div initial={{ opacity:0, y:40 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }}>
          ...
          <a href="https://wa.me/2348000000000?text=I'm%20ready%20to%20start%20my%20music%20career%20journey." target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large">💬 Chat on WhatsApp Now</a>
        </motion.div>
      </section>
    </main>
  )
