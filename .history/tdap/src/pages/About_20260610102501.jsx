      ...
      <AnimatedSection><section className="about-content">
        <div className="about-grid">
          ...
          <div className="about-text">
            ...
            <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp"><import { FaWhatsapp } from "react-icons/fa6"; Let's Work Together</a>
          </div>
        </div>
