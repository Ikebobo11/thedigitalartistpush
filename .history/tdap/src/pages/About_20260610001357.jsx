...
import { teamMembers, timelineData } from '../data/serviceData.js'
  ...
  return (
    <main>
      ...
      <AnimatedSection><section className="about-content">
        <div className="about-grid">
          ...
          <div className="about-text">
            ...
            <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp">💬 Let's Work Together</a>
          </div>
        </div>
      ...
      <AnimatedSection><section className="cta-section">
        ...
        <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large">💬 Be Part of Our Growth</a>
      </section></AnimatedSection>
    </main>
  )
}
