    ...
    <main>
      ...
      <AnimatedSection><section className="about-content">
        <div className="about-grid">
          <img src="https://i.pinimg.com/736x/44/86/59/4486598d87585e478c7a1b8d6414b90c.jpg" alt="" className="about-image" loading="lazy" />
          <div className="about-text">
            ...
            <a href="https://wa.me/2347074171697" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp"><FaWhatsapp /> Let's Work Together</a>
          </div>
        </div>
      ...
      <section className="mission-vision">
        <div className="mv-grid">
          <AnimatedSection><div className="mv-card"><h3><GoGoal /> Our Mission</h3><p>To empower independent artists worldwide with professional-grade music distribution, marketing, and promotional services that help them reach their full potential and build sustainable music careers.</p></div></AnimatedSection>
          <AnimatedSection><div className="mv-card"><h3><FaEye /> Our Vision</h3><p>To become the leading global platform for independent artist growth, connecting talent with audiences across every continent while maintaining the highest standards of service and innovation.</p></div></AnimatedSection>
          <AnimatedSection><div className="mv-card"><h3><IoDiamond /> Core Values</h3><p>Integrity, transparency, innovation, and dedication. We believe in putting artists first, delivering measurable results, and maintaining the highest ethical standards in everything we do.</p></div></AnimatedSection>
        </div>
      </section>
      ...
      <AnimatedSection><section className="cta-section">
        ...
        <p className="cta-subtitle">We're on a mission to expand our reach to 10+ countries, bringing professional music services to independent artists everywhere.</p>
        <a href="https://wa.me/2347074171697" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large"><FaWhatsapp /> Be Part of Our Growth</a>
      </section></AnimatedSection>
    </main>
  )
}
