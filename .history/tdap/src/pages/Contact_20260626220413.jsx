...
function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    window.open(
      `https://wa.me/2347074171697?text=${encodeURIComponent(`Hello The Digital Artis Push! My name is ${form.name}. I'm interested in ${form.service || "your services"}. Message: ${form.message}`)}`,
      "_blank",
    );
  };
