    ...
    <motion.section className="service-detail" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
      ...
      <div className="section-container">
        ...
        <div className="service-cta-wrapper">
          <a href={`https://wa.me/2347074171697?text=${encodeURIComponent(service.whatsapp)}`} target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large"><FaWhatsapp /> Reach Out On WhatsApp To Get Started</a>
        </div>
      </div>
    </motion.section>
  )
      ...
      <section className="services-hero">
        ...
        <motion.div initial={{ opacity:0, y:40 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8 }} className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <a href="https://wa.me/2347074171697" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large"><FaWhatsapp /> Talk To Us</a>
          </div>
        </motion.div>
      </section>
