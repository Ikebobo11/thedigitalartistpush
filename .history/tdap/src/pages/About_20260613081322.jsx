    ...
    <main>
      ...
      <section className="mission-vision">
        <div className="mv-grid">
          ...
          <AnimatedSection><div className="mv-card"><h3>< Our Vision</h3><p>To become the leading global platform for independent artist growth, connecting talent with audiences across every continent while maintaining the highest standards of service and innovation.</p></div></AnimatedSection>
