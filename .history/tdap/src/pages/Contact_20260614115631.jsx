...
function Contact() {
  ...
  const handleSubmit = e => {
    e.preventDefault()
    window.open(`https://wa.me/2347074171697?text=${encodeURIComponent(`Hello The Digital Artist Push! My name is ${form.name}. I'm interested in ${form.service||'your services'}. Message: ${form.message}`)}`, '_blank')
  }
    ...
    <main>
      ...
      <section className="cta-section">
        <motion.div initial={{ opacity:0, y:40 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }}>
          ...
          <a href="https://wa.me/2347074171697?text=I'm%20ready%20to%20start%20my%20music%20career%20journey." target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp btn-large"><FaWhatsapp /> Chat on WhatsApp Now</a>
        </motion.div>
      </section>
    </main>
  )
