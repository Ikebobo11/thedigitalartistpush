  ...
  return (
    <main>
      ...
      <AnimatedSection><section className="cta-section">
        ...
        <p className="cta-subtitle">We're on a mission to expand our reach to 1+ countries, bringing professional music services to independent artists everywhere.</p>
