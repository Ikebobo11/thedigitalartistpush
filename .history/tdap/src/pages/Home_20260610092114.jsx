...
function Home() {
  ...
  const platforms = [
    { name: 'Spotify', icon: FaSpotify}, { name: 'Apple Music', icon: '🍎' }, { name: 'Audiomack', icon: SiAudiomack },
    { name: 'Boomplay', icon: '🎶' }, { name: 'YouTube', icon: FaYoutube }, { name: 'TikTok', icon: FaTiktok },
    { name: 'Instagram', icon: FaInstagram }, { name: 'Facebook', icon: '👍' }, { name: 'X (Twitter)', icon: '🐦' },
  ]
