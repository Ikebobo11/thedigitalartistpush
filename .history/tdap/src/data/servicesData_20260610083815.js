...
export const servicesData = [
  {
    id: 'distribution', icon: '🌍', title: 'Music Distribution Services', subtitle: 'Get your music on all major streaming platforms worldwide',
  ...
  {
    id: 'spotify', icon: '🟢', title: 'Spotify Services', subtitle: 'Dominate Spotify with playlisting, ads, and strategic promotion',
  ...
  {
    id: 'apple-music', icon: '🍎', title: 'Apple Music Services', subtitle: 'Premium promotion on Apple Music ecosystem',
  ...
  {
    id: 'audiomack', icon: '🔊', title: 'Audiomack Services', subtitle: 'Grow your presence on Africa\'s favorite streaming platform',
  ...
  {
    id: 'boomplay', icon: '🎶', title: 'Boomplay Services', subtitle: 'Expand your reach on Africa\'s largest music streaming service',
  ...
  {
    id: 'youtube', icon: '▶️', title: 'YouTube Services', subtitle: 'Complete YouTube growth and monetization solutions',
  ...
  {
    id: 'tiktok', icon: '🎵', title: 'TikTok Services', subtitle: 'Go viral on the world\'s fastest-growing platform',
  ...
  {
    id: 'instagram', icon: '📸', title: 'Instagram Services', subtitle: 'Build your brand on the visual platform',
  ...
  {
    id: 'facebook', icon: '👍', title: 'Facebook Services', subtitle: 'Connect with fans on the world\'s largest social network',
  ...
  {
    id: 'twitter', icon: '🐦', title: 'X (Twitter) Services', subtitle: 'Amplify your voice on the real-time conversation platform',
  ...
  {
    id: 'media-pr', icon: '📰', title: 'Media PR & Publicity', subtitle: 'Get featured in top media publications',
  ...
  {
    id: 'blog', icon: '📝', title: 'Blog Services', subtitle: 'Promotion on top music blogs and news sites',
  ...
  {
    id: 'google', icon: '🔍', title: 'Google Services', subtitle: 'Build your search presence and online authority',
  ...
  {
    id: 'creative-design', icon: '🎨', title: 'Creative Visual Design', subtitle: 'Professional visual content for your music brand',
...
export const whyChooseUs = [
  { icon: '🚀', title: 'Proven Track Record', desc: 'Years of experience helping independent artists achieve their music career goals with measurable results.' },
  { icon: '🌍', title: 'Global Reach', desc: 'Distribution and promotion across 200+ countries with access to major DSP editorial teams worldwide.' },
  { icon: '💎', title: 'Premium Quality', desc: 'Professional-grade service delivery with attention to detail in every campaign we manage.' },
  { icon: '🤝', title: 'Dedicated Support', desc: 'Personal account managers who work closely with you throughout your entire promotional journey.' },
  { icon: '📊', title: 'Data-Driven Strategy', desc: 'We use real data and analytics to craft promotion strategies that deliver maximum ROI.' },
  { icon: '🔒', title: '100% Ownership', desc: 'You retain full rights to your music. We never take ownership or royalties from your work.' }
]
