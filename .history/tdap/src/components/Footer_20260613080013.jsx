    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div>
          <h4>Contact</h4>
          <ul className="footer-links">
            <li><a href="mailto:thedigitalartistpush@gmail.com">thedigitalartistpush@gmail.com</a></li>
            <li><a href="https://wa.me/2347074171697">WhatsApp: +234 470 741 71694</a></li>
            <li>Lagos, Nigeria</li>
            <li>Sun - Mon: 8AM - 11PM</li>
          </ul>
        </div>
      </div>
